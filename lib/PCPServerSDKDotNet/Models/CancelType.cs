namespace PCPServerSDKDotNet.Models
{
    ...
    /// cancelled and the Cancel should not be made for the entire ShoppingCart.
    /// For this type the list of items has to be provided. Please note that a reversal
    ...
    /// Note: If a DISCOUNT productType is among the ShoppingCart items, only
