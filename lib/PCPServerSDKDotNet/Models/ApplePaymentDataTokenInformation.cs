namespace PCPServerSDKDotNet.Models
{
    ...
    {
        /// <summary>
        /// Gets or sets version information about the payment token. Currently only EC_v1 for ECC-encrypted data is supported.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets detached PKCS #7 signature, Base64 encoded as string. Signature of the payment and header data. The signature includes the signing certificate, its intermediate CA certificate, and information about the signing algorithm.
        /// </summary>
