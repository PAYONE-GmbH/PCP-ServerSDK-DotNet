namespace PCPServerSDKDotNet.Models
{
    ...
    ///   is ready for Capture. Pre-authorizations can be reversed and can be
    ///   captured within 30 days. The capture amount can be lower than the authorized
    ///   amount.
    /// * SALE - The payment creation results in an authorization that is
    ///   already captured at the moment of approval.
