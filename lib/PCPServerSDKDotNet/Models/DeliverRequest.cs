namespace PCPServerSDKDotNet.Models
{
    ...
    public class DeliverRequest
    {
        ...
        /// <summary>
        /// Gets or sets this property indicates whether this will be the final operation. For deliverType FULL, it is always the final operation. If deliverType PARTIAL is provided and the property is set to true, the remaining amount of the items will be cancelled and the items are marked as CANCELLED.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DeliverType: ").Append(this.DeliverType).Append('\n');
