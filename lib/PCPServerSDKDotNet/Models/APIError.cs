namespace PCPServerSDKDotNet.Models
{
    ...
    public class APIError
    {
        ...
        /// <summary>
        /// Gets or sets hTTP status code for this error that can be used to determine the type of error.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets iD of the error. This is a short human-readable message that briefly describes the error.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets human-readable error message that is not meant to be relayed to customer as it might tip off people who are trying to commit fraud.
        /// </summary>
