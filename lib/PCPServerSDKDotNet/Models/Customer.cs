namespace PCPServerSDKDotNet.Models
{
    ...
    public class Customer
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CompanyInformation: ").Append(this.CompanyInformation).Append('\n');
            ...
            sb.Append("  ContactDetails: ").Append(this.ContactDetails).Append('\n');
            sb.Append("  FiscalNumber: ").Append(this.FiscalNumber).Append('\n');
