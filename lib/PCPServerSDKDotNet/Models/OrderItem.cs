namespace PCPServerSDKDotNet.Models
{
    ...
    {
        /// <summary>
        /// Gets or sets id of the item from the ShoppingCart. The id will be returned in the response from create Checkout request.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets quantity of the specific item. Must be greater than zero.  Note: Must not be all spaces or all zeros.
        /// </summary>
